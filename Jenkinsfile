        ...
        stage('5 - Tests') {
            steps {
                ...
                bat "cd \"C:\\Users\\Lenovo\\OneDrive\\Documents\\Rose\\JenkinsPoC\\Cypress_Test\""
                 bat "\"C:\\Program Files\\nodejs\\npx\" cypress run --project \"C:\\Users\\Lenovo\\OneDrive\\Documents\\Rose\\JenkinsPoC\\Cypress_Test\\cypress\\e2e\" --spec \"C:\\Users\\Lenovo\\OneDrive\\Documents\\Rose\\JenkinsPoC\\Cypress_Test\\cypress\\e2e\\test_PlataformaGroup.spec.js\" --reporter \"C:\\Users\\Lenovo\\OneDrive\\Documents\\Rose\\JenkinsPoC\\Cypress_Test\\node_modules\\mochawesome\" --reporter-options reportDir=customReportDir,reportFilename=customReportFilename --config-file \"C:\\Users\\Lenovo\\OneDrive\\Documents\\Rose\\JenkinsPoC\\Cypress_Test\\cypress.config.js\""
                echo "Culminada la ejecucion de tests"
               
            }
        }
        stage('6 - Envio E-mail') {
            steps {
